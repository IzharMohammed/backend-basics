...
SELECT name,syllabus FROM courses;

-- get all the departments
SELECT id, name FROM departments;

-- get all courses with instructor name
SELECT c.id AS course_id, c.name AS course_name, c.syllabus AS course_syllabus, i.name AS instructor_name 
FROM courses c
...
-- left join
SELECT d.name AS department_name, i.name as instructor_name, i.email  AS instructor_email
FROM departments d
LEFT JOIN instructor i
ON i.department_id = d.id
;

-- Get a specific course (by ID) with department & instructor info. List all students in a particular course.
SELECT c.name AS course_name, c.syllabus  AS course_syllabus , 
...
;
 ...
 -- List all students in a particular course. Find how many students are enrolled in each course (aggregated).
...
-- Which instructor teaches the most courses? (count courses per instructor).  Which student is enrolled in the most courses? (count enrollments).
SELECT
    i.name AS instructor_name, COUNT(c.id) AS total_courses
FROM
    instructor i
